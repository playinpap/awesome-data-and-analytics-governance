# Awesome `Data & Analytics Governance` [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
...
1. Data & Analytics Governance 수준을 파악할 수 있는 진단지를 만들자 : [**Awesome Diagnosis**](#awesome-diagnosis)   
    a. 회사 구성원 대상으로 진단할 수 있는 설문지 (Google Forms 기반)   
...
혹시 주변 환경을 측정해보고 싶으시다면 아래의 진단지 Link 로 들어가서 오른쪽 하단에 있는 **권한 요청** 부탁드립니다.   
권한을 부여 받은 후에는, 원본 설문지는 수정하지 마시고 반드시 **사본 만들기**를 한 후 그 위에서 더 잘 어울리게 custom하여 진행 부탁드립니다. 🙏   
